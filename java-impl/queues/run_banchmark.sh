...
&& java -jar target/sequential-benchmarks.jar -f 2 -wi 20 -i 20 -tu us -bm avgt -rf JSON -rff target/reports/jmh/condition-vs-bit-mask-results.json n02 \

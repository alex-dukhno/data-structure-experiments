...
public class BitMaskResizableNotShrinkArrayQueuePrimitive implements SequentialQueue {
  private int[] items;
  private int head;
  private int tail;
  private int size;

  public BitMaskResizableNotShrinkArrayQueuePrimitive() {
    this(16);
  }

  public BitMaskResizableNotShrinkArrayQueuePrimitive(int capacity) {

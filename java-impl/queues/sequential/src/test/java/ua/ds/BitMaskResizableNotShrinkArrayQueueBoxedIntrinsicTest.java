...
class BitMaskResizableNotShrinkArrayQueueBoxedIntrinsicTest {

  private BitMaskResizableNotShrinkArrayQueueBoxed queue;

  @BeforeEach
  void setUp() throws Exception {
    queue = new BitMaskResizableNotShrinkArrayQueueBoxed();
  }

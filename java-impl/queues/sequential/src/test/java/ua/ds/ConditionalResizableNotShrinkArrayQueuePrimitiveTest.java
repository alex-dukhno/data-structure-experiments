...
class ConditionalResizableNotShrinkArrayQueuePrimitiveTest {

  private ConditionalResizableNotShrinkArrayQueuePrimitive queue;

  @BeforeEach
  void setUp() throws Exception {
    queue = new ConditionalResizableNotShrinkArrayQueuePrimitive();
  }

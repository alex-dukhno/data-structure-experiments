...
import ua.ds.array.boxed.BitMaskResizableArrayQueueBoxed;

class BitMaskResizableArrayQueueBoxedTest {

  private BitMaskResizableArrayQueueBoxed queue;

  @BeforeEach
  void setUp() throws Exception {
    queue = new BitMaskResizableArrayQueueBoxed();
  }

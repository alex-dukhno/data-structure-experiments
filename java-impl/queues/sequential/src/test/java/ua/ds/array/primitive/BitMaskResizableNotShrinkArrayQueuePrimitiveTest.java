...
class BitMaskResizableNotShrinkArrayQueuePrimitiveTest {

  private BitMaskResizableNotShrinkArrayQueuePrimitive queue;

  @BeforeEach
  void setUp() throws Exception {
    queue = new BitMaskResizableNotShrinkArrayQueuePrimitive();
  }

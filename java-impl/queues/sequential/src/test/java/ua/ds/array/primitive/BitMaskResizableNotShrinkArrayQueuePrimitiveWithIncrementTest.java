...
class BitMaskResizableNotShrinkArrayQueuePrimitiveWithIncrementTest {

  private BitMaskResizableNotShrinkArrayQueuePrimitiveWithIncrement queue;

  @BeforeEach
  void setUp() throws Exception {
    queue = new BitMaskResizableNotShrinkArrayQueuePrimitiveWithIncrement();
  }

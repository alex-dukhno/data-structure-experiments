...
for i in 1 2 3 4 5
do
  cargo bench benchmarks::rc_ref_cell_linked_queue_small | tee benchmark-results/rc_ref_cell_linked_queue_small_${i}.txt
done
...
for i in 1 2 3 4 5
do
  cargo bench benchmarks::cache_check_rc_ref_cell_linked_queue | tee benchmark-results/rc_ref_cell_linked_queue_l3_cache_${i}.txt
  cargo bench benchmarks::extra_large_rc_ref_cell_linked_queue | tee benchmark-results/rc_ref_cell_linked_queue_${i}.txt
done
...
#for i in 1 2 3 4 5
#do
#  cargo bench benchmarks::cache_check_padded_64_rc_ref_cell_linked_queue | tee benchmark-results/rc_ref_cell_linked_queue_padded_64_cache_${i}.txt
#done
...
for i in 1 2 3 4 5
do
  cargo bench benchmarks::extra_large_shared_linked_queue | tee benchmark-results/shared_linked_queue_${i}.txt
done
#for i in 1 2 3 4 5
#do
...
for i in 1 2 3 4 5
do
  cargo bench benchmarks::extra_large_padded_32_shared_linked_queue | tee benchmark-results/shared_linked_queue_padded_32_${i}.txt
done
...
for i in 1 2 3 4 5
do
  cargo bench benchmarks::extra_large_padded_64_shared_linked_queue | tee benchmark-results/shared_linked_queue_padded_64_${i}.txt
done
